...
struct NodeGenerator {
    ...
    static func generatePlaneFrom(planeAnchor: ARPlaneAnchor, physics: Bool, hidden: Bool) -> SCNNode {
        ...
        // configure the position of our node to match the plane'snode.
    ...
    // configure the position of our node to match the plane's center X and Z. The Y axis is set to -5mm to account for the height we gave to our geometry
